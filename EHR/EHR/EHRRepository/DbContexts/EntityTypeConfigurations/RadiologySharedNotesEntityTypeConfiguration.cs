...
{
    public class RadiologySharedNotesEntityTypeConfiguration : IEntityTypeConfiguration<RadiologySharedNotes>
    {
        public void Configure(EntityTypeBuilder<RadiologySharedNotes> builder)
        {
            builder.ToTable("RadiologySharedNotes");
